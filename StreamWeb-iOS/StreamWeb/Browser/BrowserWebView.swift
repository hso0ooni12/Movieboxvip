    ...
    final class Coordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
        ...
        func webView(
            ...
            if navigationAction.targetFrame == nil {
                // Keep authentication/payment-style popup flows inside the app.
                // Known ad hosts are already rejected above by shouldBlockNavigation(to:).
        ...
        func webView(
            ...
            // Load legitimate popup flows (including sign-in redirects) in the
            // existing web view. Known advertising hosts are rejected above.
            webView.load(navigationAction.request)
            return nil
        }
    }
